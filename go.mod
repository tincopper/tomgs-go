...
require (
	...
	github.com/gogap/aop v0.0.0-20220622063547-602d72218eb8
...
require (
	...
	k8s.io/cli-runtime v0.18.1 // indirect
...
//replace google.golang.org/grpc v1.46.0 => google.golang.org/grpc v1.29.1
